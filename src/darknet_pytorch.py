...
def get_test_input():
	...
	img = cv2.imread("../studies/dog.jpg")
	...
	def forward(self, x, CUDA):
		...
		for i, module in enumerate(modules):        
			...
			if module_type == "convolutional" or module_type == "upsample":
				...
				else: detections = torch.cat((detections, x), 1)
...
model = Darknet("../studies/yolov3.cfg")
model.load_weights("/Users/frank/Documents/CNN/darknet/weights/yolov3.weights")
inp = get_test_input()
