...
class TestTiffUtilities(PyFibreTestCase):
    def setUp(self):
        ...
        self.test_shg_image_path = str(testing_dir / "fixtures" / "test-pyfibre-shg-Stack.tif")
        self.test_shg_pl_trans_image_path = str(testing_dir / "fixtures" / "test-pyfibre-pl-shg-Stack.tif")
