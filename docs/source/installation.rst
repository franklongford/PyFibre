...
To begin with, either clone or download the latest release of Pyfibre (currently 2.0.3) and change working
directory into the repository::

    git clone --branch '2.0.3' --depth 1 https://github.com/franklongford/PyFibre.git
    cd PyFibre
